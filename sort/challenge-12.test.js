...
const sortByLength = (strings) => {
  ...
  strings.forEach(element => {
    arrayByLength.push(element.length);
    });
    strings.sort((arrayByLength, strings) => {
      return arrayByLength - strings;
});
...
describe('Testing challenge 1', () => {
  test('It should sort high-to-low the numbers in an array', () => {
    ...
    expect(sortBackwards([3,2,1])).toStrictEqual([1,2,3]);
    expect(sortBackwards([20,12,3])).toStrictEqual([3, 12, 20]);
